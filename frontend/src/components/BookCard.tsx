 ...
 *
 * Unlike a ContentCard this never shows a lock. A book always opens — what it
 * opens onto is a chapter list where the locks actually live, and a padlock on
 * something that opens fine would be a lie. The "N free" count carries the
 * pitch instead.
 */
